...
1. **Hero** (260px) — Lifestyle photo with two-layer gradient, programme context pill ("Day 14 of 30 · Build Healthy Habits"), animated pulsing dot, greeting (`Good morning/afternoon/evening, Priya`), day-of-week subtitle, inline 47% month progress bar.
...
3. **My Transformation Journey** — `TransformationJourney` component. Hero card (340px, animated photo swap, Framer Motion), Success Blueprint card, Meal Planning coach card, Transformation Timeline (7 slots), Future Self Preview card, Journey Destination CTA → `/journey`.
...
9. **Month 3 Preview** — "Coming Next / Month 3 · Sleep Better, Feel Better", clinical label "Metabolic Correction", subtitle "Sleep. Recovery. Blood sugar optimisation.", 4 frosted tag pills.
...
- **CTA** — Dark forest card: "Keep Building Momentum / Complete Month 2 to unlock."
